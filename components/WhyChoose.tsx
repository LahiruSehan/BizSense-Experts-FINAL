          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {config.hero.whyChoose.map((item, idx) => (
                <motion.div 
                  key={idx}
                  whileHover={{ y: -5 }}
                  className="flex flex-col items-center text-center p-6 bg-white/5 backdrop-blur-sm border border-white/5 rounded-2xl hover:border-biz-emerald/30 hover:bg-white/10 transition-all group shadow-xl relative"
                >
