import { Layers, Globe, BarChart3, Calculator, ShieldCheck, Truck, ShoppingBag, Factory, Building2, Users, TrendingUp, Laptop, PieChart, Lock, Car, FileText, Settings, Rocket } from 'lucide-react';
...
export const CONFIG: SiteConfig = {
  ...
  hero: {
    ...
    mainHeadlinePrefix: "BIZSENSE ERP",
    withText: "—",
    headlines: [
