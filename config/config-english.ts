...
export const CONFIG = {
  ...
  services: [
    {
      ...
      summary: "Financial clarity through robust software architecture.",
      fullDesc: "We don't just install software; we engineer financial clarity. Our ERP solutions (Odoo, ERPNext, SAP) are designed by expert consultants to ensure regulatory compliance, inventory control, and operational scalability.",
    ...
    },
    {
      ...
      summary: "Facilitating complex global B2B commerce.",
    ...
    },
    {
      ...
      summary: "Strategies engineered for tangible revenue growth.",
    ...
    },
    {
      ...
      summary: "Bank-grade financial oversight for SMEs.",
    ...
    },
    {
      ...
      summary: "Actionable strategies to scale operations.",
  ...
  erpPage: {
    ...
    platforms: ['Odoo', 'ERP Next', 'Quick Book (Pro Advisor)', 'Zoho (Books, Inventory, CRM, People)', 'Custom ERP (BizSense ERP – Light)'],
    industries: [
      { name: "Importers & Distributors", icon: Truck },
      { name: "Exporters", icon: Globe },
      { name: "Vehicle Traders", icon: Truck },
